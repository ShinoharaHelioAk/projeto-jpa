...
public class Movimentacao {
	...
	// Esse é o lado "forte" do relacionamento bidirecional.
	// Aquele que vai realizar mudanças na base, como inclusão de várias linhas na
	// tabela.
	// Por isso, o mappedBy não entra nessa Entidade, sendo referenciado no mappedBy
	// da outra Entidade.
	@ManyToOne
	private Conta conta;
